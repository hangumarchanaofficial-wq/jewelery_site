    ...
    return (
        ...
        >
          ...
          Detail
            ...
            {/* ─── Story ─── */}
            <p className="font-body text-[0.85rem] font-light text-charcoal/75 leading-editorial mb-8 max-w-[500px]">
                {product.story}
            </p>
        ...
        <span className="font-heading text-2xl font-light text-soft-black tracking-[0.02em]">
          {product.price}
                ...
                <span className="font-body text-[0.62rem] font-normal tracking-[0.15em] uppercase text-charcoal/55">
          Starting Price
        </span>
            </div>
            ...
            <div className="mb-10">
                ...
                <div className="space-y-0">
                    {specsEntries.map((spec) => (
                        ...
                        >
              <span className="font-body text-[0.7rem] font-medium tracking-[0.08em] text-charcoal/65 w-28 shrink-0 pt-px">
                {spec.label}
              </span>
                            <span className="font-body text-[0.78rem] font-light text-charcoal/90 leading-relaxed">
                {spec.value}
              </span>
                        </div>
                    ))}
          ...
          />
            ...
            hover:border-charcoal/50"
                >
          <span
              className="absolute inset-0 bg-charcoal -translate-x-full
              transition-transform duration-500 ease-luxury group-hover:translate-x-0"
          />
                    <span className="relative z-10 flex items-center gap-3 transition-colors duration-400 group-hover:text-ecru">
            {/* WhatsApp icon */}
            ...
            <span className="font-body text-[0.68rem] font-medium tracking-[0.25em] uppercase text-charcoal/80 group-hover:text-ecru">
            ...
            {/* ─── Concierge note ─── */}
            <p className="font-body text-[0.68rem] font-light text-charcoal/55 leading-relaxed mt-5 text-center">
