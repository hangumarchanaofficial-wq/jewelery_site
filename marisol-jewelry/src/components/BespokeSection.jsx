// ============================================================
// MOBILE-OPTIMIZED BESPOKE SECTION — Clean mobile layout
// ============================================================
...
const BESPOKE_PIECES = [
    {
        ...
        detail: "Commissioned for a private collector, The Perla is a one-of-a-kind strand of South Sea pearls, hand-selected over fourteen months, each chosen for its unique lustre and oceanic depth. Set in 18k rose gold with an ethically sourced sapphire clasp, this piece is a love letter to the Mediterranean.",
        image: "https://images.unsplash.com/photo-1602751584552-8ba73aad10e1?w=800&q=85&auto=format&fit=crop",
    ...
    },
    {
        ...
        detail: "Carved from a rare 4.7-carat Colombian emerald, The Bosque sits in a sculptural platinum band inspired by intertwined branches. The setting was designed over six months, with every curve hand-finished by our master jeweler in Antwerp. A piece that breathes with the spirit of the wild.",
        image: "https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&q=85&auto=format&fit=crop",
...
function BespokePiece({ piece }) {
    ...
    const contentBlock = (
        ...
        >
            <p className="font-body text-[0.6rem] sm:text-[0.65rem] font-medium tracking-[0.35em] uppercase text-burgundy mb-4 sm:mb-5">
                {piece.label}
            </p>
            <h2 className="font-heading text-[clamp(1.7rem,3.5vw,3rem)] font-light text-burgundy leading-[1.25] mb-4 sm:mb-5">
                {piece.title}
            </h2>
            <div className="w-12 h-px bg-gradient-to-r from-burgundy to-silver mb-5 sm:mb-7" />
            <p className="font-heading text-[clamp(0.95rem,1.4vw,1.2rem)] font-light italic text-soft-black leading-[1.8] sm:leading-[1.9] mb-6 sm:mb-8">
                {piece.story}
            </p>
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8 md:gap-[clamp(40px,6vw,80px)] items-center
            mb-[clamp(60px,10vw,120px)] last:mb-0"
        >
            {piece.reverse ? (
                <>
...
export default function BespokeSection() {
    return (
        <section id="products" className="py-[clamp(60px,10vw,140px)] bg-ecru-warm">
