...
const PIECES = [
    {
        ...
        description:
            "Cascading links that mirror the movement of current over coral. The centrepiece aquamarine was cut to catch light the way the sea holds sunrise.",
    ...
    },
    {
        ...
        description:
            "The band ripples like a tide pool's edge — hand-carved in platinum, holding a sapphire the colour of the ocean at depth.",
    ...
    },
    {
        ...
        description:
            "Seafoam frozen in white gold. Each earring is asymmetric by design — because no two waves ever break the same way.",
    ...
    },
    {
        ...
        description:
            "Inspired by the line where sand meets sea at dusk. Rose gold links graduate from matte to polished — shoreline to shallows.",
    ...
    },
    {
        ...
        description:
            "From the deepest register of the collection — a Tahitian pearl suspended in blackened silver, like moonlight held beneath the surface.",
    ...
    },
    {
        ...
        description:
            "A single emerald sits in an organically sculpted gold cuff — as if the stone grew there naturally, shaped by centuries of tide.",
